...
const BASE = import.meta.env.VITE_API_BASE ?? 'https://teacher-attendance-backend-2.onrender.com/api';
...
export const simulateScan = (teacher) =>
  axios.post(`${BASE}/simulate-scan?teacher=${teacher}`).then(r => r.data);
